...
const map: Record<string, { label: string; cls: string }> = {
  ...
  in_transit:  { label: "Em Rota",    cls: "bg-[hsl(280_70%_55%/0.15)] text-[hsl(280_70%_55%)] border-[hsl(280_70%_55%/0.3)]" },
  delivered:   { label: "Finalizada", cls: "bg-success/15 text-success border-success/30" },
